...
public class Peripheral extends BluetoothGattCallback {
    ...
    public void connect(CallbackContext callbackContext, Activity activity) {
        if (gatt == null) {
            this.ICTLog += "START STATE: GATT IS NULL. ";
        } else {

        }
        if (this.isConnecting) {
            this.ICTLog += "ALREADY CONNECTING";
            callbackError();
            return;
        }
        ...
        connect2(callbackContext, activity);
    }

    public void connect2(CallbackContext callbackContext, Activity activity) {

        //this.ICTLog = "";
        BluetoothDevice device = getDevice();

        if (isConnected() || device == null) {
            this.ICTLog += "NO DEVICE OR ALREADY CONNECTED!!";
            callbackError();
            return;
        }

        if (Build.VERSION.SDK_INT < 23) {
            this.ICTLog += "CONNECT TOP";
            gatt = device.connectGatt(activity, false, this);
        } else {
            this.ICTLog += "CONNECT BOT";
            //gatt = device.connectGatt(activity, false, this, BluetoothDevice.TRANSPORT_LE);
            gatt = device.connectGatt(activity, false, this, BluetoothDevice.TRANSPORT_AUTO);
        }
    ...
    public void callbackError() {
        connectCallback.error(this.asJSONObject("ERROR1: " + this.ICTLog));
    }

    @Override
    public void onServicesDiscovered(BluetoothGatt gatt, int status) {
        this.ICTLog += " SERVICE: " + status;
        ...
        if (status == BluetoothGatt.GATT_SUCCESS) {
            ...
            connectCallback.error(this.asJSONObject("Service discovery failed" + " LOG: " + this.ICTLog));
            disconnect();
        }
    }
    ...
    public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
        Log.w("GATT STATE CHANGE", "BLE STATE: " + status + "/" + newState);
        this.ICTLog += " F= " + status + "S=" + newState + "&";
        this.gatt = gatt;
        ...
        /*
            ...
            gatt.close();
            connect2(this.connectCallback, this.activity);
        ...
        */
            ...
            if (connectCallback != null) {
                connectCallback.error(this.asJSONObject("GATT!" + " LOG: " + this.ICTLog));
            }
            disconnect();
        } else {
            this.isConnecting = false;
            if (connectCallback != null) {
                connectCallback.error(this.asJSONObject("Peripheral Disconnected!" + " LOG: " + this.ICTLog));
            }
    ...
    public void onCharacteristicChanged(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic) {
        this.ICTLog += " onCharacteristicChanged: " + characteristic + " ";
    ...
    public void onCharacteristicRead(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
        this.ICTLog += " onCharacteristicRead ";
    ...
    public void onCharacteristicWrite(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
        this.ICTLog += " onCharacteristicWrite " + characteristic + status + " ";
    ...
    public void onDescriptorWrite(BluetoothGatt gatt, BluetoothGattDescriptor descriptor, int status) {
        this.ICTLog += " onDescriptorWrite: " + descriptor + status + " ";
    ...
    public void onDescriptorRead(BluetoothGatt gatt, BluetoothGattDescriptor descriptor, int status) {
        this.ICTLog += " onDescriptorRead ";
        super.onDescriptorRead(gatt, descriptor, status);
    }

    @Override
    public void onMtuChanged(BluetoothGatt gatt, int mtu, int status) {
        this.ICTLog += " onMtuChanged ";
        super.onMtuChanged(gatt, mtu, status);
    }

    @Override
    public void onReliableWriteCompleted(BluetoothGatt gatt, int status) {
        this.ICTLog += " onReliableWriteCompleted ";
